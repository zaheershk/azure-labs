...
var iotHubName = 'z-learn-iothub'; // process.env.HUB_NAME;
var storageAccountName = 'zlearnstorage'; // process.env.ACCOUNT_NAME;

// TODO: replace the following value with the storage account key.
var storageAccountKey = 'TODO';

// Upload an image to blob storage
var azure = require('azure-storage');
var blobService = azure.createBlobService(storageAccountName, storageAccountKey);

blobService.createBlockBlobFromLocalFile('bc-poc-iot-ml-analytics-photos', 'image_19.jpg', 'assets/photos/image_19.jpg', (err, result, response) => {
    if (err) {
        ...
        // Get information about zz_cam_0003 from cameras.js
        var fs = require('fs');
        var cameras = JSON.parse(fs.readFileSync('cameras.json', 'utf8'));
        var camera = cameras.find(o => o.deviceId === 'zz_cam_0003');
